...
if __name__ == "__main__":
    ...
    def LocalUsers_List(resourceGroupName: str, accountName: str, subscriptionId: str):
    ...
    @mcp.tool(name='LocalUsers_CreateOrUpdate', description="Create or update the properties of a local user associated with the storage account")
    ...
    def EncryptionScopes_List(resourceGroupName: str, accountName: str, subscriptionId: str):
